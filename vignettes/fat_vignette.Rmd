...
In DFAT mode, treated and control units are forecast from a common reference year to ensure valid comparison of forecast errors. To do this, the 'fatEstimator' package aligns all units to the median year among the treated units.
