...
fat_unitwise <- estimate_fat(
  ...
  forecast_lag        = 0,
  pretreatment_window = "full"   # minimal window for speed
)
...
knitr::kable(
  data.frame(
    ...
    Description = c(
      ...
      "Periods to wait after treatment before forecasting (0 = in treatment year)",
...
- Check sensitivity to ploynomial degree by re-estimate using different degrees \( q_i \). (Use domain knowledge or visual inspection to guide degree selection.)
