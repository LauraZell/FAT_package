...
The **`fatEstimator`** R package implements the *Forecasted Average Treatment Effects (FAT)* methodology from [Botosaru, Giacomini, and Weidner (2024)](https://arxiv.org/abs/2401.02121), which allows for causal inference **without requiring a traditional control group**.
...
For a full overview, see the [**vignette**](./vignettes/fat_vignette.html) or run:
...
It is formally grounded in recent econometric theory and allows for flexible polynomial trends, covariates, placebo testing, and extensions with control groups (DFAT).
